...
import { Shield, Building2, HardHat, RefreshCw } from 'lucide-react';
...
export const RoleSwitcher = () => {
  ...
  return (
    <div className="flex items-center gap-1 bg-slate-950/80 p-1 rounded-lg border border-slate-800 shadow-inner">
      <span className="hidden lg:flex items-center gap-1 text-[10px] uppercase font-bold tracking-wider text-slate-400 px-2">
