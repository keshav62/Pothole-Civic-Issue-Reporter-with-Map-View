...
export const AIAnalysisCard = ({ 
  ...
  return (
    <div className="bg-gradient-to-br from-indigo-50/50 to-purple-50/50 rounded-2xl border border-indigo-100 p-5 sm:p-6 shadow-sm">
      
      {/* Header */}
      <div className="flex items-center gap-2 mb-5 pb-4 border-b border-indigo-200/50">
        <div className="w-8 h-8 rounded-lg bg-indigo-100 flex items-center justify-center text-indigo-600">
          <Sparkles className="w-4 h-4" />
        </div>
        <div>
          <h3 className="text-sm font-black text-indigo-900 tracking-wide uppercase">AI Issue Analysis</h3>
          <p className="text-[10px] font-bold text-indigo-400 uppercase tracking-widest">Automated Assessment</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-5">
        <div className="space-y-1">
          <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1">
            <FileSearch className="w-3 h-3 text-indigo-400" /> Detected Category
          </p>
        ...
        <div className="space-y-1">
          <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1">
            <Activity className="w-3 h-3 text-indigo-400" /> Confidence
          </p>
          <div className="flex items-center gap-2">
            <p className="text-sm font-black text-indigo-600">{analysis.confidence}%</p>
        ...
        <div className="space-y-1">
          <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1">
            <AlertTriangle className="w-3 h-3 text-indigo-400" /> Severity
          </p>
        ...
        <div className="space-y-1">
          <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1">
            <ShieldCheck className="w-3 h-3 text-indigo-400" /> Dept. Match
          </p>
      ...
      <div className="bg-white/60 p-4 rounded-xl border border-indigo-100/50 mb-4">
