          ...
          >
            ...
            {unreadCount > 0 && (
              <span className={`px-2 py-0.5 rounded-full text-[10px] ${
                filter === 'UNREAD' ? 'bg-indigo-100 text-indigo-700' : 'bg-slate-100 text-slate-600'
              }`}>
                {unreadCount}
              </span>
            )}
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {notification.taskId && (
                      <span className="inline-flex items-center text-[10px] font-bold text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded cursor-pointer hover:bg-indigo-100 transition-colors">
