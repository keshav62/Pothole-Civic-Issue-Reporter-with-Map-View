        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2.5">
            <Button
              ...
              leftIcon={
                <svg className="w-3.5 h-3.5 shrink-0 mr-1" viewBox="0 0 24 24">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:pt-24 pb-16 text-center">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button
            ...
            className="w-full sm:w-auto py-4 px-8 font-extrabold text-sm shadow-xl shadow-blue-500/30 transition-all hover:scale-[1.02]"
          >
            Report Issue as Citizen
          </Button>
          ...
          <Button
            ...
            className="w-full sm:w-auto py-4 px-8 font-extrabold text-xs shadow-xl transition-all hover:scale-[1.02]"
          >
            Launch Super Admin HQ
          </Button>
        </div>
      ...
      <section className="relative z-10 py-16 bg-gradient-to-r from-blue-900 via-slate-900 to-indigo-950 border-t border-slate-800">
        <div className="max-w-5xl mx-auto px-4 text-center space-y-6">
          ...
          <p className="text-xs sm:text-base text-slate-300 max-w-2xl mx-auto font-medium">
            Launch CivicConnect live in your browser and test all 4 role portals with pre-configured mock data.
          </p>
